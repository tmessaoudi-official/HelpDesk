<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupprimeHistoriqueAgence.aspx.cs" Inherits="Helpdesk.Historique.SupprimeHistoriqueAgence" %>
...
<body>
    ...
    Width="257px">
                    <asp:Label ID="Del" runat="server" Text="Supprimer L'historique ?!"></asp:Label>
                    <br />
