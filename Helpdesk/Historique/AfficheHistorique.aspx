<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfficheHistorique.aspx.cs" Inherits="Helpdesk.AfficheHistorique" %>
...
<body style="width: 1184px">
    ...
    <div id="msgboxpanel" runat="server"></div>
            ...
            <asp:Panel ID="PanelContainer" runat="server" Height="193px">
                <asp:Panel ID="PanelHeader" runat="server" BackImageUrl="~/images/Bgb.jpg" 
                    ...
                    <asp:Label ID="Label2" runat="server" ForeColor="White" Text="(More)"></asp:Label>
                </asp:Panel>
    ...
    <div style="position:absolute; top: 67px; left: 157px;">
    

            <div  style="position: absolute; left: -25px; top: 34px; width: 495px; height: 105px;">
            ...
            <eo:PageView ID="DetailleAgence" runat="server" Width="100%">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Modifié_Par" HeaderText="Modifiée Par" 
                     ...
                     <asp:BoundField DataField="TimeDebut" DataFormatString="{0:T}" Visible="false" HtmlEncode="false" HeaderText="TimeDebut" 
                        ...
                        <asp:BoundField DataField="TimeFin" Visible="false" DataFormatString="{0:T}" HtmlEncode="false" HeaderText="TimeFin" 
                         ...
                         <asp:TemplateField HeaderText="Date Démission">
                            <ItemTemplate>
                          <asp:Label ID="DateF" runat="server" Text=<%#Eval("DateFin","{0:yyyy-MM-dd}")%>></asp:Label> - <asp:Label ID="TimeF" runat="server" Text=<%#Eval("TimeFin","{0:T}")%>></asp:Label>
                            </ItemTemplate>
                            </asp:TemplateField>
                        <asp:BoundField DataField="ModifiéPar" HeaderText="ModifiéPar" 
            ...
            <eo:PageView ID="AgenceEquipements" runat="server" Width="100%">
                <asp:GridView ID="GridView3" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Date" HeaderText="Date" Visible="false" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false"
                            SortExpression="Date" />
                        <asp:BoundField DataField="Time" Visible="false" HeaderText="Time" SortExpression="Time" />
                                                <asp:TemplateField HeaderText="Date">
                            <ItemTemplate>
...
<br />
        ...
        <asp:SqlDataSource ID="HIstFrameRelay" runat="server" 
            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                ...
                SelectCommand="SELECT Etat, Adresse_IP AS IP, Description, Date AS Date, Time AS Time, Personnel AS ModifiéePar FROM Historiques_Framerelays WHERE (Framerelay_ID = @Framerelay)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="HIstAdsl" runat="server" 
            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                ...
                SelectCommand="SELECT Etat_Tunnel, Etat_Carte, Adresse_Tunnel, Adresse_Carte, Description, Date AS Date, Time AS Time, Personnel AS ModifiéePar FROM Historiques_Adsls WHERE (Adsl_ID = @Adsl)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="HIstLiaison" runat="server" 
            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                ...
                SelectCommand="SELECT Liaison_Description, Date AS Date, Time AS Time, Personnel AS ModifiéePar FROM Historiques_Agences WHERE (Agence_ID = @Liaison)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="HIstModem" runat="server" 
            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                ...
                SelectCommand="SELECT Etat, Type + '-' + Model AS Type, Date AS Date, Time AS Time, Personnel AS ModifiéePar, Description FROM Historiques_Modems WHERE (Modem_ID = @Modem)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="HIstSwitcheur" runat="server" 
            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                ...
                SelectCommand="SELECT Etat, Type + '-' + Model AS Type, Adresse_IP, Adresse_MAC, Description, Date AS Date, Time AS Time, Personnel AS ModifiéePar FROM Historiques_Switcheurs WHERE (Switcheur_ID = @Switcheur)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="HIstRouteur" runat="server" 
            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                ...
                SelectCommand="SELECT Etat, Type + '-' + Model AS Type, Adresse_IP, Adresse_MAC, Description, Date AS Date, Time AS Time, Personnel AS ModifiéePar FROM Historiques_Routeurs WHERE (Routeur_ID = @Routeur)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="HIstEquipement" runat="server" 
            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                ...
                SelectCommand="SELECT Equipement_Description, Date AS Date, Time AS Time, Personnel AS ModifiePar FROM Historiques_Agences WHERE (Agence_ID = @Equipement)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="HIstAgence" runat="server" 
            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                ...
                SelectCommand="SELECT Code, Nom, Adresse_IP, Zone + ', ' + Adresse AS Adresse, Description, Date AS Date, Time AS Time, Personnel AS Modifié_Par FROM Historiques_Agences WHERE (Agence_ID = @IDAgence)">
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="0" Name="IDAgence" 
                    QueryStringField="IDAgence" />
            </SelectParameters>
