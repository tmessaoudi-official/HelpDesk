...
<body>
    <form style="position:absolute; top: 20px; left: 10px; height: 310px; width: 827px;" 
    id="form1" runat="server">
    <div id="msgboxpanel" runat="server"></div>
        <div style="height: 317px; width: 844px;">
            <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" CssClass="AjoutWizard"
