...
public class SimpleSNMP2
{
    public static void Main(string[] argv)
    {
        ...
        System.Web.HttpContext.Current.Response.Write("  sysName - Datatype: " + datatype + output);
        ...
        datastart = 26 + commlength + miblength;
        output = Encoding.ASCII.GetString(response, datastart, datalength);
        System.Web.HttpContext.Current.Response.Write("  sysLocation - Datatype: " + datatype + output);
        ...
        datastart = 26 + commlength + miblength;
        output = Encoding.ASCII.GetString(response, datastart, datalength);
        System.Web.HttpContext.Current.Response.Write("  sysContact - Datatype: " + datatype + output);
        ...
        System.Web.HttpContext.Current.Response.Write("  sysUptime - Datatype: " +
               datatype + uptime);
    }
}
