<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="Helpdesk.Insert" %>
...
<body style="background-color:transparent;">
    ...
    <div id="msgboxpanel" runat="server"></div>
            <div style=" position:absolute; width: 247px; margin-top: -8; margin-left: -8; height: 281px; top: 6px; left: 4px; right: 782px;">
    ...
    <p align="center"><font size="+3" Color="teal">Ajout D'une Agence</font></p>
    ...
    <SideBarTemplate>
                    ...
                    <asp:WizardStep runat="server" ID="ResponsableAgence" Title="Responsable De L'agence">
                        <table id="Respo" style="position:absolute; top: 37px; left: 34px;">
                        <tr><td>
                            <eo:ComboBox AutoPostBack="true" ID="ComboBox1" runat="server" ControlSkinID="None" 
                                ...
                                <DropDownTemplate>
                                    ...
                                    <div style="width:500px;height:400px;font-family:Verdana; font-size:12px;padding:4px;">
...
<table id="Assignedbuttons">
         ...
         SelectCommand="SELECT ID, Nom + ' ' + Prenom AS Detaille FROM Responsables WHERE (Niveau = 3) AND (Role = 2) AND ID IN (SELECT Responsable FROM Agences)">
       <SelectParameters>
                                                                                                                                                                   </SelectParameters>
                                        </asp:SqlDataSource>
 </td>
 <td>
    <eo:ListBox AutoPostBack="true" ID="Autres" runat="server" ControlSkinID="None" DataTextField="Detaille" OnSelectedIndexChanged="Autres_SelectedIndexChanged" 
                                DataValueField="ID" DataSourceID="AutreResponsable" Height="200px" 
                                            Width="224px">
                                            <ListBoxStyle CssText="font-family: Tahoma; font-size:12px;background-color:white;" />
                                            <HeaderStyle CssText="background-image:url('00106001');background-position-x:left;background-position-y:top;background-repeat:repeat;height:16px;padding-bottom:2px;padding-left:7px;padding-right:2px;padding-top:6px;height:19px;margin-bottom:3px;" />
                                            <ItemListStyle CssText="padding: 4px;" />
...
<ButtonStyle CssText="width:17px;height:23px;"></ButtonStyle>
                                                        ...
                                                        <asp:Button CssClass="button" ID="CancelResp" Text="Refresh" runat="server" 
                            OnClick="CancelResp_Click" />
                                &nbsp;</td></tr>
                            </table>
                        </asp:WizardStep>
                        <asp:WizardStep runat="server" ID="DetailAgence" Title="Détaille Agence">
                            <table ID="DetailleAgence" runat="server">
                                <tr runat="server">
                                    ...
                                    <td runat="server">
                                          <asp:DropDownList AutoPostBack="true" OnSelectedIndexChanged="SubmitChange" 
                                              ID="DropDownListAgenceZone" runat="server" 
                                            DataSourceID="AgenceZone" DataTextField="Zones" DataValueField="ID" 
                                   ...
                                   <a runat="server" id="Dele" href="#" onclick="TaskDelete();">
                                        <asp:Image ID="Image3" runat="server" ToolTip="Delete Zone" 
                                            ...
                                            ConnectionString="<%$ ConnectionStrings:AgencesConnectionString %>" 
                                              ...
                                              SelectCommand="SELECT ID, ' Zone Du ' + Libelle AS Zones FROM Zones">
                                        </asp:SqlDataSource>                               
                                        </td>
                                </tr>
                        ...
                        <asp:WizardStep runat="server" ID="Switcheur" Title="Switcheur">
                        ...
                        <asp:WizardStep runat="server" ID="DetaillLiaison" Title="Détaille Liaisons">
                            ...
                            <tr id="Tr15" runat="server">
                                ...
                                <td id="Td30" runat="server" rowspan="3">
