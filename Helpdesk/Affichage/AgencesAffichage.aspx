<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgencesAffichage.aspx.cs" Inherits="Helpdesk.AgencesAffichage" %>
...
<body>
    ...
    <div id="msgboxpanel" runat="server"></div>                <div style=" position:absolute; width: 247px; margin-top: -8; margin-left: -8; height: 281px; top: 0px; left: 4px; right: 783px;">
    ...
    <p align="center"><font size="+3" Color="teal">&nbsp;&nbsp;&nbsp;&nbsp; Consulter les agences</font></p>
        ...
        <asp:GridView EmptyDataText="Aucune Agence Dans cette zone" ID="GridView1" runat="server" AllowPaging="True" 
            ...
            ForeColor="Black" GridLines="None" HorizontalAlign="Center" DataKeyNames="ID" Font-Names="Andalus" Font-Size="13pt">
            ...
            <Columns>
             ...
             <asp:TemplateField>
             <ItemTemplate>
             <a href="AfficheAgence.aspx?IDAgence=<%#Eval("ID")%>"><asp:Image ImageUrl="~/images/Affiche.gif" runat="server" ID="Afficher" ToolTip="Afficher" Height="25px" Width="30px"></asp:Image></a>
             </ItemTemplate>
             </asp:TemplateField>
             <asp:TemplateField>
             <ItemTemplate>
             <a href="Update.aspx?IDAgence=<%#Eval("ID")%>"><asp:Image ImageUrl="~/images/Modif.png" runat="server" ID="Modifier" ToolTip="Modifier" Height="25px" Width="30px"></asp:Image></a>
             </ItemTemplate>
             </asp:TemplateField>
                                                                 <asp:TemplateField>
             <ItemTemplate>
             <a href="../Historique/AfficheHistorique.aspx?IDAgence=<%#Eval("ID")%>"><asp:Image ImageUrl="~/images/Historique.png" runat="server" ID="Historique" ToolTip="Consulter l'historique" Height="25px" Width="30px"></asp:Image></a>
             </ItemTemplate>
             </asp:TemplateField>
                                       <asp:TemplateField>
             <ItemTemplate>
             <a><asp:Image ImageUrl="~/images/close-button.png" runat="server" ID="Supprime" ToolTip="Supprime" Height="25px" Width="30px"></asp:Image></a>
...
<iframe scrolling="no" id="IframeEdit2" src="SupprimeAgence.aspx?IDAgence=<%#Eval("ID")%>" frameborder="0"></iframe>
</asp:Panel>
             </ItemTemplate>
             </asp:TemplateField>
           ...
           <asp:SqlDataSource ID="SqlDataSource1" OnSelected="CheckSqlSelected" 
        onselecting="CheckSqlSelecting" runat="server" 
