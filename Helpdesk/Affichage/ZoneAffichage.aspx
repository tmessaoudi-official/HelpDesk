<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZoneAffichage.aspx.cs" Inherits="Helpdesk.ZoneAffichage" %>
...
<body style="width: 889px; margin-right: 0px">
    <form id="form1" runat="server">
    <div id="msgboxpanel" runat="server"></div> 


      <div style="width: 889px; height: 439px; margin-right: 0px; direction: ltr;">
    ...
    <p align="center"><font size="+3" Color="teal">&nbsp;&nbsp;&nbsp;&nbsp; Consulter les agences</font></p>
       ...
       <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="10"
            AutoGenerateColumns="False" DataSourceID="Zone" 
            ...
            ForeColor="Black" GridLines="None" HorizontalAlign="Center"
                    Font-Names="Andalus" Font-Size="13pt">
                        <AlternatingRowStyle BackColor="#CCCCCC" />
                        <Columns>
                <asp:BoundField DataField="ID" Visible="false" HeaderText="ID" 
                    InsertVisible="False" ReadOnly="True" SortExpression="ID" />
                <asp:BoundField DataField="Libelle" HeaderText="Zone" 
                    SortExpression="Libelle" />
             <asp:TemplateField>
             <ItemTemplate>
             <a href="AgencesAffichage.aspx?Zone=<%#Eval("ID")%>"><asp:Image ImageUrl="~/images/Affiche.gif" runat="server" ID="Afficher" ToolTip="Afficher" Height="25px" Width="30px"></asp:Image></a>
             </ItemTemplate>
             </asp:TemplateField>
...
<iframe style="width: 240px; height: 280px;" id="IframeEdit" src="Zone.aspx?Page=Affiche&Mode=editzone&IDZone=<%#Eval("ID")%>" frameborder="0" scrolling="no"></iframe>
</asp:Panel>
             </ItemTemplate>
             </asp:TemplateField>
...
<iframe scrolling="no" id="IframeEdit2" src="Zone.aspx?Page=Affiche&Mode=deletezone&IDZone=<%#Eval("ID")%>" frameborder="0"></iframe>
</asp:Panel>
             </ItemTemplate>
             </asp:TemplateField>
            ...
            SelectCommand="SELECT ID, Libelle FROM Zones">
        </asp:SqlDataSource>
        </div>
...
<iframe scrolling="no" id="IframeEdit3" src="Zone.aspx?Page=Affiche&Mode=newzone" frameborder="0"></iframe>
</asp:Panel>
</div>
    </form>
</body>
